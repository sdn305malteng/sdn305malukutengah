      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-3">
            <button
              onClick={onOpenAdmin}
              className={`relative z-50 pointer-events-auto cursor-pointer inline-flex items-center space-x-2 px-4 py-2.5 rounded-lg text-sm font-bold shadow-xs transition-all duration-200 ${
                isAdminLoggedIn
